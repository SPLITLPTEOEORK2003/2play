...
BT.editChannel("520461249243381773", {name : "🌹WEL"})
BT.editChannel("520461249243381773", {name : "🌹WELC"})
BT.editChannel("520461249243381773", {name : "🌹WELCO"})
BT.editChannel("520461249243381773", {name : "🌹WELCOM"})
BT.editChannel("520461249243381773", {name : "🌹WELCOME"})
BT.editChannel("520461249243381773", {name : "🌹WELCOME T"})
BT.editChannel("520461249243381773", {name : "🌹WELCOME TO"})
BT.editChannel("520461249243381773", {name : "🌹WELCOME TO P"})
BT.editChannel("520461249243381773", {name : "🌹WELCOME TO PR"})
BT.editChannel("520461249243381773", {name : "🌹WELCOME TO PRO🌹"})
  ...
  if(hours3 > 12) {
              ...
              if (hours == 0) {
                  ...
                  client.on('message', message => {
                      ...
                      if (message.author.id !== '353708472690540564') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
